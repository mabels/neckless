import { JsonPublicMember, PublicMember } from '../member/member'

export interface JsonGem {
	PubKeys: JsonPublicMember[]
}

export interface Gem {
	PubKeys: Map<string, PublicMember>
	Pearl:   OpenPearl
...
export function Create(gems: PublicMember[]):Gem {
	gem := Gem{
